...
function formatPhone(val){var num=val.value;var len=num.toString().length;for(var i=0;i<len;i++){var a=num.charAt(i);if(isNaN(a)){num=num.replace(a,'');len--;i--;}
if(a==' '){num=num.replace(a,'');len--;i--;}}
val.value=num;if(val.value.length>10)val.value=val.value.substring(0,10);var re=/\D/;var re2=/^\d{3}-\d{3}-\d{4}/;var num=val.value;if(num.length==10){newNum=num.substring(0,3)+'-'+num.substring(3,6)+'-'+num.substring(6,10);val.value=newNum;$('#tcpa').show();}}
...
Please enter your cellphone so we can text you value.
  ...
  <div class="small-12 large-10 large-centered columns">
							<form id="geoform" role="form" class="custom" method="get" action="index.php">
							
							
							<div class="row" style="margin-top:30px">
    <div class="large-12 columns">
      <label><div class="subsoon text-center" style="margin-bottom:4px">Your Cell Phone</div>
          <input type="text" name="cellphone" placeholder="Enter Your Cell Phone" onkeyup="formatPhone(this)">
								...
								<BR><BR><BR><BR>
								<strong>TCPA Notice</strong><HR>
								If you choose to supply your cell phone number, you hereby consent to receive autodialed and/or pre-recorded telemarketing calls and/or text messages from My Street Value & its clients. You also certify that the provided number is your actual cell phone number and not that of anyone else. Furthermore, if your cell phone number changes, we ask for prompt notice of the new number.
								</div>
...
<br>
	     You received this by My Street Value.	
							</p>			
					</section>
		...
		<div class="loader">
			<div id="f">
				<div id="f_1" class="f"></div><div id="f_2" class="f"></div><div id="f_3" class="f"></div><div id="f_4" class="f"></div><div id="f_5" class="f"></div><div id="f_6" class="f"></div><div id="f_7" class="f"></div><div id="f_8" class="f"></div>		
			</div>
		</div>
